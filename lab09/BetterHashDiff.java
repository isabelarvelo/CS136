...
public class BetterHashDiff extends Diff {
	...
	protected Hashtable<BetterIntPair, Association<Integer, String>> myHash;
	...
	*/
	public BetterHashDiff(String file1Name, String file2Name) {
		...
		myHash = new Hashtable<BetterIntPair, Association<Integer, String>>();
	}
	 ...
	 * necessary).  The value is the diff output. */
	 ...
	 remainingFile2Index) {
		 ...
		 //storing indices in a class with a more robust hash function
		 BetterIntPair myPair = new BetterIntPair(remainingFile1Index, remainingFile2Index);
