...
public class TestLinkedList {
	...
	public static void getTest(LinkedList<String> list) {
		...
		compareList(" 5 4 3 2 1 0", list);

	}
	/**
	 * Tests removeFirst() and removeLast() functionality
	 * This test relies on addFirst, so please thoroughly
	 * test those methods first.
	 *
	 * @param list an empty list
	 * @pre list list is empty and not null
	 */
	public static void removeFirstLastTest(LinkedList<String> list) {
		assert list.size() == 0;

		System.out.println("removeFirst() and removeLast() test:");
	...
	public static void main(String[] args) {
		...
		//new Test for get Method
		getTest(list);
		clearTest(list);

		removeFirstLastTest(list);

		//remaining methods are tested in the main method of my LinkedList class
